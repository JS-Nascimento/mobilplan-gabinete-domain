...
//                        TipoFrente.PUXADOR_PERFIL,
//                        4,
//                        frentes,
//                        new FolgasGavetas(TipoFundo.ENCAIXADO, 26, 350, 30, 15, 6, 10, PadraoDeFitagem.UMA_ALTURA),
//                        PadraoDeFitagem.QUATRO_LADOS, 18));
//
//        gaveteiro.definirDimensoes(new Dimensoes(500, 800, 400, 15));
//
//        System.out.println("Componentes.Dimensoes do gabinete:" + gaveteiro.getDimensoes().toString());
//        System.out.println("Componentes.Dimensoes Internas do gabinete:" + gaveteiro.getDimensoesInternas().toString());
//
//        gaveteiro.definirAcabamentosCaixa(List.of(mdfCaixa));
//
//        for (String componente : gaveteiro.listarComponentes()) {
